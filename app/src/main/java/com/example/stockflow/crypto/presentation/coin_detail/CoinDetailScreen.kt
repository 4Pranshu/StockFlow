...
import com.example.stockflow.crypto.presentation.coin_detail.components.InfoCard
import com.example.stockflow.crypto.presentation.coin_list.CoinListState
...
import com.example.stockflow.crypto.presentation.models.toDisplayableNumber
import com.example.stockflow.ui.theme.greenBackground
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            FlowRow(
                ...
                InfoCard(
                    title = stringResource(R.string.chnage_last_24),
                    formattedText = absoluteChnageFormatted.formatted,
